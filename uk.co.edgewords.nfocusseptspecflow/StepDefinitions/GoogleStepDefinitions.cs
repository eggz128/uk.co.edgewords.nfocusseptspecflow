...
using static uk.co.edgewords.nfocusseptspecflow.StepDefinitions.Hooks;

namespace uk.co.edgewords.nfocusseptspecflow.StepDefinitions
{
    [Binding]
    public class GoogleStepDefinitions
    {
        ...
        public void GivenIAmOnTheGoogleHomepage()
        {
            ...
            // or maybe driver.FindElement(By.XPath("//button[contains(.,'Accept all')]"));
            acceptButton.Click();
